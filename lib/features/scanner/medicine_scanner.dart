...
class _MedicineScannerState extends State<MedicineScanner> with SingleTickerProviderStateMixin {
  File? image;
  ...
  Future<void> processImage() async {
    ...
    try {
      ...
      if (ocrText.trim().isEmpty) {
        setState(() {
          extractedText = "No medicine name detected.";
          aiExplanation = "❌ No medicine information detected. Please scan a medicine package or strip with visible text.\n\n⚠️ **Disclaimer**: This scanner is designed specifically for medicine packaging.";
          isLoading = false;
        });
        return;
      }
      ...
      setState(() {
        extractedText = "Found text: ${ocrText.split('\n').first}... Analyzing...";
      });

      final explanation = await aiService.getMedicineInfo(ocrText);
      ...
      setState(() {
        ...
        aiExplanation = "❌ Error processing image. Please try again.\n\n💡 Tips:\n• Ensure good lighting\n• Keep the camera steady\n• Focus on the text area";
        isLoading = false;
      });
    }
  }
                      ...
                      child: GestureDetector(
                        ...
                        child: Container(
                          ...
                          child: Row(
                            ...
                            children: [
                              Icon(Icons.camera_alt, color: Colors.white, size: width * 0.05),
                      ...
                      child: GestureDetector(
                        ...
                        child: Container(
                          ...
                          child: Row(
                            mainAxisAlignment: MainAxisAlignment.center,
                            children: [
                              Icon(Icons.search, color: Colors.white, size: width * 0.05),
                              SizedBox(width: width * 0.02),
                              Text(
                                'Search',
                                style: TextStyle(
                ...
                child: SingleChildScrollView(
                  ...
                  child: Column(
                    children: [
                      ...
                      // Results
                      if (!isLoading && aiExplanation.isNotEmpty)
                        Container(
                          padding: EdgeInsets.all(width * 0.04),
                          decoration: BoxDecoration(
                            gradient: LinearGradient(
